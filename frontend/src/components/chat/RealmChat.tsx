...
const RealmChat: React.FC<RealmChatProps> = observer(({ realm, username, onUsernameSubmit }) => {
  ...
  return (
    <div className="p-4 bg-gray-900 border border-gray-700 rounded-lg w-full  mx-auto mt-4">
      ...
      {showModal && <UsernameModal onSubmit={(name) => {
